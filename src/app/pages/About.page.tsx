      ...
      <Container p={0} my="auto">
        ...
        >
          <ScrollArea.Autosize>
            ...
            <Text>
              Our mission is simple: help you find your next favorite spot
              without the usual headache. Instead of listening to influencers or
              paid reviews, we tap into something more powerful: the real
              experiences of everyday Singaporeans like you.
              <br />
              <br />
            ...
            <Text>
              ...
              hawker centre or a cozy cafe for your next date, we&apos;ve got
              your back. Ready to find something good? Try GoodMeh lah - confirm
              plus chop you&apos;ll discover something nice!
            </Text>
          </ScrollArea.Autosize>
        </Card>
      </Container>
