...
export const GoodmehLogoInline: React.FC<React.SVGProps<SVGSVGElement>> = (
  props,
) => {
  return (
    <svg
    ...
    >
      ...
      <g>
        <path
          className="st0"
          d="M224.49,83.22c-4.95-14.84-6.18-22.26-3.71-33.38s6.18-24.73,17.31-29.68c11.13-4.95,19.17-0.62,19.17-0.62
          ...
          C62.52,115.36,55.1,103,62.52,90.64s44.51-1.24,56.88,4.95c12.36,6.18,33.38,25.97,37.09,30.91s-18.47-8.78-25.97-13.6
